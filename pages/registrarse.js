          ...
          <div className=' max-w-lg w-full'>
            ...
            className='bg-white rounded shadow-md px-8 pt-6 pb-8 mb-4'>
                <div className='mb-4'>
                    ...
                    name='nombre' id='nombre' type='text' className=' shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' placeholder='Nombre'/>
